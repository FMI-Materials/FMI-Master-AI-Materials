...
# The problem is considered solved if the last 100 episodes havea mean score of >= -120
...
# Install ffmpeg both as binary (make sure it works from your terminal: ffmpeg -version) and for your python/conda environment
# At the end, it will generate a movie mp4 in the folder with the latest simulation result.
...
min_lr = 0.009 #Minimum Learning Rate
lr_decay = 0.999
...
epsilon_end = 0.05 # The end point / min of the epsilon
...
def display_frames_as_gif(frames):
    ...
    #HTML(anim.to_html5_video()) #(anim, default_mode='loop'))
    #HTML(anim.to_jshtml())
